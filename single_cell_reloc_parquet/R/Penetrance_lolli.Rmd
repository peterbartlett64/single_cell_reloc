...
penetrances_updated <- read_parquet("D:/ALL_FINAL/Combined_by_perc/penetrance_updated.parquet", col_select = c("Protein", "Percentage_reloc", "updated_yet_perc", "MMS_localization_class")) %>%
  na.omit()
...
compartmental_comparison <-  ggplot(filter(penetrances_updated, !MMS_localization_class %in% c("ER foci", "nuc periph", "nucleolus")), aes (x = Percentage_reloc, y = updated_yet_perc, color = MMS_localization_class))+
  geom_point()+
  stat_ellipse() +
