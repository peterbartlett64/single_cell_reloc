...
def imgIndex_er(image_path, microfluidics_results):
	...
	def f_lazer(z):
		start = z.find('d0222r2p340200')+15
	...
	imgIndex["Run"] = 2 #imgIndex["Run"].astype('str')
	# imgIndex["Hour/Run_t"] = imgIndex["Hour/Run_t"].astype("str")
	imgIndex["Unique_pos"] = "d0222r2p340200" #imgIndex['Date'] +"r" + imgIndex["Run"] + "p" + imgIndex['PositionID']
...
analyze = "D:/testingSUPPORT/New_training/Just_the_one/d0222r2p340200"
microfluidics_results = "D:/testingSUPPORT/New_training/Just_the_one/d0222r2p340200"
