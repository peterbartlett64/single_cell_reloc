...
from plotnine import ggplot, aes, geom_pointdensity, aes, stat_bin, facet_wrap
import polars as pl
#%%
dataframe = pd.read_parquet("E:/ALL_FINAL/Combined_by_perc/XRS2d0210_selected.parquet")
