...
if __name__ == '__main__':
	...
	results_final = pd.read_parquet("D:/Sandbox/subset_end.parquet", columns=['Cell_Barcode', 'ImageID', 'Relocalized', 'Loc_score']).reset_index(drop = False) #* This will take a milwhile since it is a 4G file
	...
	merged_indices = merged_indices.loc[(merged_indices['Unique_pos_image'] == "d0218r2p570300")|(merged_indices['Unique_pos_image'] == "d0218r2p600200")]# | (merged_indices['Unique_pos_image'] == "d0222r2p300200")] #. These are barcodes for FLR1. Don't forget to change if looking for a different protien
