...
def read_and_modify_intensity(image_path:str, cell_mask_path:str, quantification_path:str, unique_frame:str,normalization_method:str):
	...
	cell_factor = np.empty(cell_mask.shape).astype('float32') #. This should be corrected to int16
...
if __name__ == '__main__':
	...
	Parallel(n_jobs=Global_variables['cpu_se'], verbose= 100)(delayed(yet_mask_manager)(frame = f) for f in frames.unique())
