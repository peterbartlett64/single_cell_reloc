...
if __name__ == '__main__':
	...
	'post_path': "D:/TRY AGAIN", #Todo: This needs to be changed to a input call
	'subset': False,
	'subset_by': '',
	'subset_collection': '',
	'cpu_se': os.cpu_count(),
...
#%% Correction
full_data['Loc_score_log'] = pd.Series(full_data['Loc_score']).apply(lambda x: math.log(x))
group_prot_frame = full_data.groupby(["Protein", "Frame"]) #. This may need to be changed to jsut regular "Frame"
full_data["z_score_Log_Loc"] = group_prot_frame["Loc_score"].transform(stats.zscore)
