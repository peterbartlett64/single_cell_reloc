...
if __name__ == '__main__':
	...
	for percentile in list_percentiles:
		...
		for c in Chamber_index["Chamber"]:
			...
			All_pos_allt_unified_prot_percentages = pd.merge(All_pos_allt_unified_prot_percentages, percentage_reloc_p, how = 'outer', on='Frames_post_treatment', suffixes=('', '_y'))
			All_pos_allt_unified_prot_percentages.drop(All_pos_allt_unified_prot_percentages.filter(regex='_y$').columns, axis=1, inplace=True)
