...
microfluidic_results  = gv.slash_switch(input("microfluidic_results"))
...
post_path = "D:/Microfluidics/RESULTS/2023-06-19"
...
time_per_frame = Experimental_info['timepoint_gap'] ###### This is set and could be placed in a more convient place.
