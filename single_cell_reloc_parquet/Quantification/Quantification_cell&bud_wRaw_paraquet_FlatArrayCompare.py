...
import single_cell_reloc_parquet.Quantification.info_index_er as info_er
...
#* This file was derived from the Early July (2023) version
...
if __name__ == "__main__":
	...
	Global_variables = {'microfluidics_results': gv.slash_switch(input("microfluidics_results?")),
						...
						'subset_collection': ['d0224r1p050200', 'd0224r1p060300', 'd0224r1p090200', 'd0224r1p1050200', 'd0224r1p1060300', 'd0224r1p1090200', 'd0224r1p1150200', 'd0224r1p1160300', 'd0224r1p1190200', 'd0224r1p150200', 'd0224r1p160300', 'd0224r1p190200', 'd0224r1p200200', 'd0224r1p250200', 'd0224r1p260300', 'd0224r1p290200', 'd0224r1p300200', 'd0224r1p350200', 'd0224r1p360300', 'd0224r1p390200', 'd0224r1p450200', 'd0224r1p460300', 'd0224r1p490200', 'd0224r1p550200', 'd0224r1p560300', 'd0224r1p590200', 'd0224r1p650200', 'd0224r1p660300', 'd0224r1p690200', 'd0224r1p750200', 'd0224r1p760300', 'd0224r1p790200', 'd0224r1p850200', 'd0224r1p860300', 'd0224r1p890200', 'd0224r1p950200', 'd0224r1p960300', 'd0224r1p990200'],
						'cpu_se': 16
	}
...
info_er.info_index_er() #* Call to get the info in case it has been missed earlier
	...
	try:
		...
		for k in Cell_index_TP["track_index"]:
			try:
				...
				# x10thPercentile_norm_OBJ_Median_GFP = np.percentile(normGFPbyMedian_object, 10)
				# x20thPercentile_norm_OBJ_Median_GFP = np.percentile(normGFPbyMedian_object, 20)
				# x30thPercentile_norm_OBJ_Median_GFP = np.percentile(normGFPbyMedian_object, 30)
				# x40thPercentile_norm_OBJ_Median_GFP = np.percentile(normGFPbyMedian_object, 40)
				# x50thPercentile_norm_OBJ_Median_GFP = np.percentile(normGFPbyMedian_object, 50)
				# x60thPercentile_norm_OBJ_Median_GFP = np.percentile(normGFPbyMedian_object, 60)
				# x70thPercentile_norm_OBJ_Median_GFP = np.percentile(normGFPbyMedian_object, 70)
				x80thPercentile_norm_OBJ_Median_GFP = np.percentile(normGFPbyMedian_object, 80)
				x90thPercentile_norm_OBJ_Median_GFP = np.percentile(normGFPbyMedian_object, 90)
				x95thPercentile_norm_OBJ_Median_GFP = np.percentile(normGFPbyMedian_object, 95)
				x99thPercentile_norm_OBJ_Median_GFP = np.percentile(normGFPbyMedian_object, 99) # This is for finding foci

				## Decile bins for normalized against OBJECT (cell) MEAN
				# x10thPercentile_norm_OBJ_Mean_Intensity_GFP = np.percentile(normGFPbyMean_object, 10)
				# x20thPercentile_norm_OBJ_Mean_Intensity_GFP = np.percentile(normGFPbyMean_object, 20)
				# x30thPercentile_norm_OBJ_Mean_Intensity_GFP = np.percentile(normGFPbyMean_object, 30)
				# x40thPercentile_norm_OBJ_Mean_Intensity_GFP = np.percentile(normGFPbyMean_object, 40)
				# x50thPercentile_norm_OBJ_Mean_Intensity_GFP = np.percentile(normGFPbyMean_object, 50)
				# x60thPercentile_norm_OBJ_Mean_Intensity_GFP = np.percentile(normGFPbyMean_object, 60)
				# x70thPercentile_norm_OBJ_Mean_Intensity_GFP = np.percentile(normGFPbyMean_object, 70)
				# x80thPercentile_norm_OBJ_Mean_Intensity_GFP = np.percentile(normGFPbyMean_object, 80)
				x90thPercentile_norm_OBJ_Mean_Intensity_GFP = np.percentile(normGFPbyMean_object, 90)
				x95thPercentile_norm_OBJ_Mean_Intensity_GFP = np.percentile(normGFPbyMean_object, 95)
				x99thPercentile_norm_OBJ_Mean_Intensity_GFP = np.percentile(normGFPbyMean_object, 99)  # This is for finding foci

				## Decile bins for normalized against OBJECT (cell) TOTAL
				# x20thPercentile_norm_OBJ_Total_Intensity_GFP = np.percentile(normGFPbyTotal_intensity_object, 20)
				# x10thPercentile_norm_OBJ_Total_Intensity_GFP = np.percentile(normGFPbyTotal_intensity_object, 10)
				# x30thPercentile_norm_OBJ_Total_Intensity_GFP = np.percentile(normGFPbyTotal_intensity_object, 30)
				# x40thPercentile_norm_OBJ_Total_Intensity_GFP = np.percentile(normGFPbyTotal_intensity_object, 40)
				# x50thPercentile_norm_OBJ_Total_Intensity_GFP = np.percentile(normGFPbyTotal_intensity_object, 50)
				# x60thPercentile_norm_OBJ_Total_Intensity_GFP = np.percentile(normGFPbyTotal_intensity_object, 60)
				# x70thPercentile_norm_OBJ_Total_Intensity_GFP = np.percentile(normGFPbyTotal_intensity_object, 70)
				# x80thPercentile_norm_OBJ_Total_Intensity_GFP = np.percentile(normGFPbyTotal_intensity_object, 80)
				x90thPercentile_norm_OBJ_Total_Intensity_GFP = np.percentile(normGFPbyTotal_intensity_object, 90)
				x95thPercentile_norm_OBJ_Total_Intensity_GFP = np.percentile(normGFPbyTotal_intensity_object, 95)
				x99thPercentile_norm_OBJ_Total_Intensity_GFP = np.percentile(normGFPbyTotal_intensity_object, 99)  # This is for finding foci

				## Decile bins normalized against BACKGROUND intesntity MEDIAN
				# x10thPercentile_norm_BKGRND_Median_GFP = np.percentile(normGFPbyBackground_median, 10)
				# x20thPercentile_norm_BKGRND_Median_GFP = np.percentile(normGFPbyBackground_median, 20)
				# x30thPercentile_norm_BKGRND_Median_GFP = np.percentile(normGFPbyBackground_median, 30)
				# x40thPercentile_norm_BKGRND_Median_GFP = np.percentile(normGFPbyBackground_median, 40)
				# x50thPercentile_norm_BKGRND_Median_GFP = np.percentile(normGFPbyBackground_median, 50)
				# x60thPercentile_norm_BKGRND_Median_GFP = np.percentile(normGFPbyBackground_median, 60)
				# x70thPercentile_norm_BKGRND_Median_GFP = np.percentile(normGFPbyBackground_median, 70)
				# x80thPercentile_norm_BKGRND_Median_GFP = np.percentile(normGFPbyBackground_median, 80)
				x90thPercentile_norm_BKGRND_Median_GFP = np.percentile(normGFPbyBackground_median, 90)
				x95thPercentile_norm_BKGRND_Median_GFP = np.percentile(normGFPbyBackground_median, 95)
				x99thPercentile_norm_BKGRND_Median_GFP = np.percentile(normGFPbyBackground_median, 99)  # This is for finding foci

				##  Decile bins normalized against BACKGROUND intenstiy MEAN
				# x10thPercentile_norm_BKGRND_Mean_GFP = np.percentile(normGFPbyBackground_mean, 10)
				# x20thPercentile_norm_BKGRND_Mean_GFP = np.percentile(normGFPbyBackground_mean, 20)
				# x30thPercentile_norm_BKGRND_Mean_GFP = np.percentile(normGFPbyBackground_mean, 30)
				# x40thPercentile_norm_BKGRND_Mean_GFP = np.percentile(normGFPbyBackground_mean, 40)
				# x50thPercentile_norm_BKGRND_Mean_GFP = np.percentile(normGFPbyBackground_mean, 50)
				# x60thPercentile_norm_BKGRND_Mean_GFP = np.percentile(normGFPbyBackground_mean, 60)
				# x70thPercentile_norm_BKGRND_Mean_GFP = np.percentile(normGFPbyBackground_mean, 70)
				# x80thPercentile_norm_BKGRND_Mean_GFP = np.percentile(normGFPbyBackground_mean, 80)
				x90thPercentile_norm_BKGRND_Mean_GFP = np.percentile(normGFPbyBackground_mean, 90)
				x95thPercentile_norm_BKGRND_Mean_GFP = np.percentile(normGFPbyBackground_mean, 95)
				x99thPercentile_norm_BKGRND_Mean_GFP = np.percentile(normGFPbyBackground_mean, 99)  # This is for finding foci

				##  Decile bins normalized against BACKGROUND intensity TOTAL
				# x10thPercentile_norm_BKGRND_Total_intensity_GFP = np.percentile(normGFPbyBackground_total, 10)
				# x20thPercentile_norm_BKGRND_Total_intensity_GFP = np.percentile(normGFPbyBackground_total, 20)
				# x30thPercentile_norm_BKGRND_Total_intensity_GFP = np.percentile(normGFPbyBackground_total, 30)
				# x40thPercentile_norm_BKGRND_Total_intensity_GFP = np.percentile(normGFPbyBackground_total, 40)
				# x50thPercentile_norm_BKGRND_Total_intensity_GFP = np.percentile(normGFPbyBackground_total, 50)
				# x60thPercentile_norm_BKGRND_Total_intensity_GFP = np.percentile(normGFPbyBackground_total, 60)
				# x70thPercentile_norm_BKGRND_Total_intensity_GFP = np.percentile(normGFPbyBackground_total, 70)
				# x80thPercentile_norm_BKGRND_Total_intensity_GFP = np.percentile(normGFPbyBackground_total, 80)
				x90thPercentile_norm_BKGRND_Total_intensity_GFP = np.percentile(normGFPbyBackground_total, 90)
				x95thPercentile_norm_BKGRND_Total_intensity_GFP = np.percentile(normGFPbyBackground_total, 95)
				x99thPercentile_norm_BKGRND_Total_intensity_GFP = np.percentile(normGFPbyBackground_total, 99)  # This is for finding foci
...
# path = 'E:/Microfluidics/MOST FINAL/Raw_quant/2023-09-14'
...
#%%
with open("C:/Users/pcnba/Grant Brown's Lab Dropbox/Peter Bartlett/Peter Bartlett Data/Code/single_cell_reloc/single_cell_reloc_parquet/Post_quant/post_quant_SEP_2023_both_file_start_RUSHCALL.py") as f:
    exec(f.read())
