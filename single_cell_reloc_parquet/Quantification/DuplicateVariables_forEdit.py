#
#? This is for modifying the variables for a direct comparison of outputs in a single file. The alternative is just to run the quantification again (twice) and changing the reference images (regular -> denoised)
