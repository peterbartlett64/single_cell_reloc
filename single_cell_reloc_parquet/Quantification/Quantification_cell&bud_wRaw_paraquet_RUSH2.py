...
skip_date = ['d0209', 'd0210', 'd0211', 'd0212', 'd0213', 'd0216', 'd0217', 'd0218', 'd0219', 'd0220', 'd0221', 'd0222', 'd0223', 'd0224']
...
def Quant_frame(i):
	...
	try:
		...
		try:
			GFP_path = imgIndex_TP.loc[(i, "GFP"), ["Path"]].values[0][0]
		except KeyError:
			GFP_path = imgIndex_TP.loc[(i, "gre"), ["Path"]].values[0][0]
		mKO_path = imgIndex_TP.loc[(i, "mKO"), ["Path"]].values[0][0]
		mKate_path = imgIndex_TP.loc[(i, "mKa"), ["Path"]].values[0][0]
