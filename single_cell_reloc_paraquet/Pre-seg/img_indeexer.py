...
def imgIndex_er(image_path = global_variables["analyze"], microfluidics_results = global_variables["microlfuidics_results"]):
    os.chdir(image_path)
...
if __name__ == "__main__":
	analyze = slash_switch(input("Where is anlyze/are the images stored?"))
	microfluidics_results = input("Where is the data output?")
