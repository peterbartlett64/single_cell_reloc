...
date = 'Sep27';
pos = 'd0213r1p150200'
posFingerprint = char('position150200');
length = double(102);
path_seg = char('F:\Microfluidics\RESULTS\d0213r1p150200\GFP_mKO_mKa');
path_raw  = char('F:\Microfluidics\Analyze\20180213_hr1833_MMS\2018-02-13_18-44-50');
