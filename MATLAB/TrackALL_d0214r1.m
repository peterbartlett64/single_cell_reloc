...
length = 83;
path_seg = char("D:\Test\d0214r1_track_comparison\d0214r1p090200_mod\GFP_mKO_mKa");
...
Tracker.configuration.ParameterConfiguration.setMaxExpectedMovement(210.0000);
Tracker.configuration.ParameterConfiguration.setMeanCellDiameter(28.0000);
Tracker.configuration.ParameterConfiguration.setNeighbourhoodSearchRadius(190.0000);
